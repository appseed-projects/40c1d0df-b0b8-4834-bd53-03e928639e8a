...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-26 12:09`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/40c1d0df-b0b8-4834-bd53-03e928639e8a.git
$ cd 40c1d0df-b0b8-4834-bd53-03e928639e8a
```
